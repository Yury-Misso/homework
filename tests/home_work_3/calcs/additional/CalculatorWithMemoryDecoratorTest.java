...
public class CalculatorWithMemoryDecoratorTest {
    private static CalculatorWithMemoryDecorator calc
            = new CalculatorWithMemoryDecorator(new CalculatorWithMathCopy());
    ...
    public void loadTest() {
        ...
        Assertions.assertEquals(calc.load(), actualResult);
    }
}
