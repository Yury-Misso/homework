...
public class CalculatorWithCounterAutoDecoratorTest {
    private static CalculatorWithCounterAutoDecorator calc
            = new CalculatorWithCounterAutoDecorator(new CalculatorWithMathCopy());
    ...
    public void getCountOperationTest() {
        ...
        double secondNumber = -16;
        double actualResult = firstNumber + secondNumber;
        double expectedResult = calculatorWithCounterAutoSuper.sum(firstNumber, secondNumber);
        Assertions.assertEquals(calculatorWithCounterAutoSuper.getCountOperation(), 1);
    }
}
