...
public class CalculatorWithCounterClassicTest {
    private static CalculatorWithCounterClassic calc = new CalculatorWithCounterClassic();
    ...
    public void getCountOperationTest() {
        ...
        double secondNumber = -16;
        double actualResult = firstNumber + secondNumber;
        double expectedResult = calculatorWithCounterClassic.sum(firstNumber, secondNumber);
        Assertions.assertEquals(calculatorWithCounterClassic.getCountOperation(), 1);
    }
}
